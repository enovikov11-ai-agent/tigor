...
from secret import SECRET_TELEGRAM_API_KEY, TELEGRAM_ADMIN_CHAT_ID, TELEGRAM_XECUT_CHAT_ID
...
admin_chat_id = int(TELEGRAM_ADMIN_CHAT_ID)
admin_not_allowed = "Это админская команда, работает только в чате администраторов"

xecut_chat_id = int(TELEGRAM_XECUT_CHAT_ID)
xecut_not_allowed = "Эта команда работает только в чате хакспейса Xecut"
